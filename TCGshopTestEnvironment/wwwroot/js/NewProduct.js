...
$(document).ready(function() {
    ...
    $.getJSON("/Products/GetCategoryAll",
        function(result) {
            $.each(result,
                function(i, field) {
                    //console.log(field)
...
Upload.prototype.doUpload = function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            console.table(
                data); // where html is the key of array that you want, $response['html'] = "<a>something..</a>";
